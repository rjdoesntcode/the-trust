...
The instruments were drafted with the assistance of an AI system, Anthropic's Claude, at the publisher's direction, and were reviewed and revised by the publisher, who holds editorial responsibility for them. The review responses were generated by OpenAI's GPT‑5.6 Sol, Google's Gemini and xAI's Grok in response to the publisher's prompts and are attributed to each model and its maker; those attributed to Grok were created with Grok. AI output can be wrong; the records cite their sources, and readers should verify against them.
